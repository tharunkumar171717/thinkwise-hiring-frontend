...
/**
 * Pretty requirement URL rooted in Analytics:
 * /analytics/requirements/:reqSlug → resolves the slug to the requirement id
 * and renders the regular requirement detail view, keeping the Analytics
 * origin alive in the breadcrumb trail.
 */
export default function AnalyticsReqSlugView() {
